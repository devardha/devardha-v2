...
const CommentBox = ({ comments, postComment, postReply, replyOpen, setReplyOpen, totalComment, message, setMessage }) => {
                            ...
                            ) }
                            {
                                replyOpen === item.id && (
                                    <div className="comment__template comment__box comment__reply">
                                        { message && message.type === 'reply' && <p className="comment__message">{message.msg}</p> }
                                        <form className="comment__right" onSubmit={postReply}>
                                            ...
                                            <div className="buttons">
                                                <button>Send</button>
                                                <span onClick={() => {setReplyOpen(null); setMessage({})}}>Cancel</span>
                                            </div>
                                        </form>
                                    </div>
                                )
                ...
                }
                {
                    replyOpen === null && (
                        ...
                        <div className="comment__template comment__box">
                            { message && message.type === 'comment' && <p className="comment__message">{message.msg}</p> }
